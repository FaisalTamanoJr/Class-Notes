...
References used:
  - Fundamentals of Electric Circuits by Charles Alexander and Matthew Sadiku (Chapter 4)
tags:
  - lesson
---
...
- # [[source transformation|Source transformation]]
	...
	- ![[independent source transformation.png|400]]
		...
		- Cases when source transformation is not possible:
			- Replacing an ideal voltage source ($R=0$)
			- Replacing an ideal current source ($R=\infty$)
- # [[Thevenin’s theorem]]
- # [[Norton’s theorem]]